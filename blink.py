...
#csv_files = ['230518_102548_HJY0518_48_Quick_Blink.csv']
...
for file in csv_files:
    ...
    if total_time > 0 and blink_number >= 2:
        # 전체 데이터에 대한 표준편차 계산
    ...
    output.append([file, total_time, blink_number, blink_frequency, average_blink_interval_variability, blink_interval_variability_by_time])

#file output
out = pd.DataFrame(output, columns=['file', 'time', 'blink_number', 'blink_frequency', 'average_blink_interval_variability', 'blink_interval_variability_by_time'])
csv_filename = 'blink_data_left.csv'
